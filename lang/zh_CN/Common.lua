CommonTranslationTable = {
	...
	["global_effect"] = "全局效果",
	["aoe"] = "AOE",
	["single_target_trick"] = "单目标符卡",
	["multiple_target_trick"] = "多目标符卡",
	["delayed_trick"] = "延时符卡",
	["movable_delayed_trick"] = "流动性延时符卡",
	["unmovable_delayed_trick"] = "一次性延时符卡",
	["buff_card"] = "辅助伤害",
	["damage_spread"] = "伤害传导",
	["weapon"] = "武器",
	["armor"] = "防具",
	...
	["#Recover"] = "%from 回复了 %arg 格残机",
	["#AskForPeaches"] = "%from 向 %to 求药，一共需要 %arg 张【<font color=\"yellow\"><b>药</b></font>】",
	["#ChooseKingdom"] = "%from 选择了 %arg 势力",
	["#NullificationDetails"] = "【<font color=\"yellow\"><b>弹幕反则</b></font>】的目标是 %from 对 %to 的符卡 【%arg】",
	...
	["$PasteCard"] = "%from 对 %to 使用延时符卡 %card",
	...
	["#TurnOver"] = "%from 将角色牌牌翻面，现在是 %arg",
	["face_up"] = "正面朝上",
	["face_down"] = "背面朝上",
	["#SkipPhase"] = "%from 跳过了 %arg 阶段",
	["#SkipAllPhase"] = "%from 当前回合结束",
	["#IronChainDamage"] = "%from 处于横置状态，将受到传导的属性伤害",
	["#LoseHp"] = "%from 失去了 %arg 格残机",
	["#LoseMaxHp"] = "%from 失去了 %arg 格残机上限",
	["#GainMaxHp"] = "%from 增加了 %arg 格残机上限",
	["#GetHp"] = "%from 当前残机为 %arg ，残机上限为 %arg2",
	...
	["@askforslash"] = "你可以对你攻击范围内的一名其她角色使用一张【幕】",
	...
	["$CancelWithoutTarget"] = "%from 使用的 【%arg】被取消",-- eg.【避】 【弹幕反则】
